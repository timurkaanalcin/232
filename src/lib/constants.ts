...
export const ROLE_PERMISSIONS: Record<RoleId, Permission[]> = {
  ...
  operator: ["admin.access", "stats.view", "map.live_view", "sessions.view", "sessions.manage", "risk.view"],
  viewer: ["admin.access", "stats.view", "map.live_view", "sessions.view", "risk.view"],
  user: [],
};
