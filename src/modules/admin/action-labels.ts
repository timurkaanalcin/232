...
export const ACTION_LABELS: Record<string, { label: string; tone: Tone }> = {
  ...
  [AUDIT_ACTIONS.ADMIN_WALLET_CREATED]: { label: "Wallet created", tone: "default" },
  [AUDIT_ACTIONS.ADMIN_WALLET_STATUS_CHANGED]: { label: "Wallet status", tone: "warning" },
  [AUDIT_ACTIONS.ADMIN_WALLET_TRANSFER_CREATED]: { label: "Wallet transfer", tone: "default" },
  [AUDIT_ACTIONS.ADMIN_WALLET_TRANSFER_REVERSED]: { label: "Transfer reversed", tone: "destructive" },
