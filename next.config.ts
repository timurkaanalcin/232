...
const csp = [
  ...
  "img-src 'self' data: blob: https://*.tile.openstreetmap.org https://lh3.googleusercontent.com https://*.googleusercontent.com https://images.unsplash.com https://*.wikimedia.org https://i.ytimg.com https://img.youtube.com",
